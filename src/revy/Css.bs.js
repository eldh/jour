...
function gridColumn(start, end$p) {
  return d("gridColumn", start.toString() + (" / " + end$p.toString()));
}

function gridRow(start, end$p) {
  return d("gridRow", start.toString() + (" / " + end$p.toString()));
}
...
function columnCount(x) {
  return d("columnCount", typeof x === "object" ? x.VAL.toString() : (
                x === "initial" ? "initial" : (
                    x === "inherit_" ? "inherit" : (
                        x === "unset" ? "unset" : "auto"
                      )
...
function textOverflow(x) {
  return d("textOverflow", typeof x === "object" ? x.VAL : (
                x === "initial" ? "initial" : (
                    x === "inherit_" ? "inherit" : (
                        x === "ellipsis" ? "ellipsis" : (
                            x === "unset" ? "unset" : "clip"
